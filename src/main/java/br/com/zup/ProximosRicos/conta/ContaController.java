...
public class ContaController {
    ...
    public List<Evento> mostrarEventoPorIdConta(@PathVariable int numeroConta,
        ...
        //Caso TipoEvento(@RequestParam) seja preenchido, este if fará filtragem
        // e adicionará a lista de eventos só os filtrados.
        if (tipoEvento != null) {
        ...
        // este foreach adicionará todos os eventos a lista de eventos.
        else {
            for (Evento evento : conta.getEventos()) {
                eventos.add(evento);
            }
